...
public class BatalhaNaval {
	...
	public static void main(String[] args){
		...
		while(acertos!=3);
		System.out.println("\n\n\nJogo Terminado. Você acertou os três navios em " + tentativas + " tentativas");
		mostraTabuleiro(tabuleiro);
	}
	...
	public static void iniciaNavios(int[][] navios){
		...
		for(int navio =0; navio<3; navio++){
			...
			//checar se esse par não foi sorteado. Se foi, sai do do...while enquanto sortear um diferente
	...
	public static void dicas(int[] tiro, int[][]navios, int tentativas){
		int linha = 0;
		int coluna = 0;
